...
export default function SignalCoded(){
    ...
    <div className="signal-coded-container">
        ...
        {selectValue === "D2"?(
            ...
            xAxisData={data.ECGDerivations[0].t} 
            yAxisData={data.ECGDerivations[2].ecgD2}></Graphic>
        ):(null)}
        {selectValue === "D3"?(
            <Graphic title="Derivación D3" GraphicId="ECGD3"
            xAxisData={data.ECGDerivations[0].t} 
            yAxisData={data.ECGDerivations[3].ecgD3}></Graphic>
        ):(null)}
        {selectValue === "AVR"?(
            <Graphic title="Derivación aVR" GraphicId="ECGAVR"
            xAxisData={data.ECGDerivations[0].t} 
            yAxisData={data.ECGDerivations[4].ecgAVR}></Graphic>
        ):(null)}
        {selectValue === "AVL"?(
            <Graphic title="Derivación aVL" GraphicId="ECGAVL"
            xAxisData={data.ECGDerivations[0].t} 
            yAxisData={data.ECGDerivations[5].ecgAVL}></Graphic>
        ):(null)}
        {selectValue === "AVF"?(
            <Graphic title="Derivación aVF" GraphicId="ECGAVF"
            xAxisData={data.ECGDerivations[0].t} 
            yAxisData={data.ECGDerivations[6].ecgAVF}></Graphic>
        ):(null)}
        {selectValue === "V1"?(
            <Graphic title="Derivación V1" GraphicId="ECGV1"
            xAxisData={data.ECGDerivations[0].t} 
            yAxisData={data.ECGDerivations[7].ecgV1}></Graphic>
        ):(null)}
        {selectValue === "V2"?(
            <Graphic title="Derivación V2" GraphicId="ECGV2"
            xAxisData={data.ECGDerivations[0].t} 
            yAxisData={data.ECGDerivations[8].ecgV2}></Graphic>
        ):(null)}
        {selectValue === "V3"?(
            <Graphic title="Derivación V3" GraphicId="ECGV3"
            xAxisData={data.ECGDerivations[0].t} 
            yAxisData={data.ECGDerivations[9].ecgV3}></Graphic>
        ):(null)}
        {selectValue === "V4"?(
            <Graphic title="Derivación V4" GraphicId="ECGV4"
            xAxisData={data.ECGDerivations[0].t} 
            yAxisData={data.ECGDerivations[10].ecgV4}></Graphic>
        ):(null)}
        {selectValue === "V5"?(
            <Graphic title="Derivación V5" GraphicId="ECGV5"
            xAxisData={data.ECGDerivations[0].t} 
            yAxisData={data.ECGDerivations[11].ecgV5}></Graphic>
        ):(null)}
        {selectValue === "V6"?(
            <Graphic title="Derivación V6" GraphicId="ECGD6"
            xAxisData={data.ECGDerivations[0].t} 
            yAxisData={data.ECGDerivations[12].ecgV6}></Graphic>
        ):(null)}
        {selectValue === "Taquicardia"?(
            <Graphic title="Taq." GraphicId="Taq"
            xAxisData={data.ECGExamples[0].xTrouble} 
            yAxisData={data.ECGExamples[1].ecgTaquicardia}></Graphic>
        ):(null)}
        {selectValue === "FA"?(
            <Graphic title="FA" GraphicId="FA"
            xAxisData={data.ECGExamples[0].xTrouble} 
            yAxisData={data.ECGExamples[2].ecgFA}></Graphic>
        ):(null)}
    </div>);
}